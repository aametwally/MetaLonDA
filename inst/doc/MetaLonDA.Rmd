...
output.metalonda.f5 = metalonda(Count = metalonda_test_data[5,], Time = Time, Group = Group,
                                ID = ID, n.perm = 10, fit.method = "nbinomial", points = points,
...
In our example, we used 10 permutations just to showcase how MetaLonDA works. In real analysis, this number should be at least 1000.
